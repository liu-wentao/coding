...
public class HibernateOnetoMany {
	...
	public void testUpdate() {
		...
		try {
			...
			LinkMan lucy = session.get(LinkMan.class, 5);
			//2 设置持久态对象值
			//把联系人放到客户里面
	...
	public void testAddDemo2() {
		...
		try {
			...
			linkMan1.setLkm_name("xupeng");
			linkMan1.setLkm_gender("nan");
			linkMan1.setLkm_phone("211");
			//2 把联系人放到客户里面
